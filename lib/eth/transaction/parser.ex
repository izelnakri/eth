defmodule ETH.Transaction.Parser do
  ...
  def parse("0x" <> encoded_transaction_rlp) do
    [nonce, gas_price, gas_limit, to, value, data, v, r, s] = encoded_transaction_rlp
  ...
  def parse(<<transaction_rlp>>) do
    [nonce, gas_price, gas_limit, to, value, data, v, r, s] = transaction_rlp
      |> ExRLP.decode
